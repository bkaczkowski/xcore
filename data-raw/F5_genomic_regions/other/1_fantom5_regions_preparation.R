...
gencode_gr = rtracklayer::import.gff(con = "~/projects/resources/gencode/gencode31/gencode.v31.annotation.gff3.gz")
gencode_TxDb = GenomicFeatures::makeTxDbFromGRanges(gencode_gr, drop.stop.codons = TRUE)
...
gencode_annotation = data.frame(cbind( gencode_gr$gene_id , gencode_gr$gene_name, gencode_gr$gene_type ), stringsAsFactors = F)
...
rm(gencode_TxDb, gencode_gr,gencode_anno, gencode_anno_df)
