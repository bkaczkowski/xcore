...
Biostrings::writeXStringSet(promoters_1.1kb_seq, "data-raw/F5_genomic_regions/promoters_1.1kb_seq.fasta")
save(promoters_1.1kb_seq    , file = "data-raw/F5_genomic_regions/promoters_1.1kb_seq.rda" )
...
Biostrings::writeXStringSet(enhancers_1.1kb_seq, "data-raw/F5_genomic_regions/enhancers_1.1kb_seq.fasta")

save(enhancers_1.1kb_seq , file = "data-raw/F5_genomic_regions/enhancers_1.1kb_seq.rda" )
