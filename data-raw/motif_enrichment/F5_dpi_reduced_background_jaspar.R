...
bg_jaspar_dpi_reduced = PWMEnrich::makeBackground(motifs = jaspar , bg.seq = promoters_ext500_seq ,algorithm="human" )

save( bg_jaspar_dpi_reduced , file = "data-raw/motif_enrichment/bg_jaspar_dpi_reduced.rda")
