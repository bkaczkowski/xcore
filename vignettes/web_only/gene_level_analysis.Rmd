...
This vignette uses xcore version 1.2.0, which is still in devel branch of 
Biocondutor and to be realeased in mid-Octorber. To use it please install
xcore and xcoredata from the devel branch.
